        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="/e-commerce/register" class="btn btn-sm btn-neutral">Register</a>
            </div>
          </div>
        </div>
      </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                 ...
                 <c:forEach var="customer" items="${customer}">
						...
						<c:url var="updateLink" value="/customer/update_customer">
							<c:param name = "id" value="${customer.id}"/>
						</c:url>
						
						<!-- construct an "update" link with admin id -->
						<c:url var="updatePasswordLink" value="/customer/update_customer_password">
							<c:param name = "id" value="${customer.id}"/>
						</c:url>
