        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="display-2 text-white"> Page Not Found</h1>
              <p class="text-white mt-0 mb-5">${message}</p>
              Return to <a class="" href="/e-commerce">
                <i class="ni ni-tv-5 text-primary"></i>
                <span class="nav-link-text text-white ">home page</span>
              </a>
            </div>
          </div>
        </div>
