    ...
    <div class="container">
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
        <div class="navbar-collapse-header">
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="/e-commerce">
                <img src="${pageContext.request.contextPath}/resource/assets/img/brand/blue.png">
              </a>
            </div>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a href="/e-commerce/login" class="nav-link">
        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form:form action="/e-commerce/customer/save_new_admin" role="form" modelAttribute="user" method="POST">
              <!-- Place for messages: error, alert etc ... -->
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    ...
                    <form:input path="name" class="form-control" name="name" placeholder="First Name" type="text"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    ...
                    <form:input path="lastName" class="form-control" name="" placeholder="Last Name" type="text"/>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
