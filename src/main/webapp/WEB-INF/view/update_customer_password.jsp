      ...
      <div class="row">
        <div class="col-xl-8 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form:form action ="save_customer_password" modelAttribute="user" method="POST">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-description">Password</label>
                        <form:input path="newPassword" type="password" id="input-description" class="form-control" placeholder="password" />
                      </div>
                    </div>
