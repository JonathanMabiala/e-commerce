      ...
      <div class="row">
        <div class="col-xl-8 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form:form action ="addNewShoe" modelAttribute="shoe" method="POST">
              <!-- need to associate this data with shoe id -->
				<form:hidden path="id"/>
				
                <h6 class="heading-small text-muted mb-4">Shoe information</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-brand">Brand</label>
                        <form:input path="brand" type="text" id="input-brand" class="form-control" placeholder="Brand" />
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <form:input path="name" type="text" id="input-model" class="form-control" placeholder="Model" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <form:input path="description" type="text" id="input-description" class="form-control" placeholder="Description" />
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-category">Category</label>
                         <form:input path="category" type="text" id="input-description" class="form-control" placeholder="Category" />
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-size">Size</label>
                         <form:input path="shoeSize" type="text" id="input-size" class="form-control" placeholder="Size" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-stock">Stock</label>
                         <form:input path="quantity" type="text" id="input-stock" class="form-control" placeholder="quantity" />
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-price">Price</label>
                         <form:input path="price" type="text" id="input-price" class="form-control" placeholder="price" />
                      </div>
                    </div>
               ...
               <div class=" text-right">
                  ...
                  <input class="btn btn-md btn-primary" type="submit" value="add">
                </div>
              </form:form>
            </div>
          </div>
