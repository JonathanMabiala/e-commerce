      ...
      <div class="container-fluid">
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <security:authorize access="hasAnyAuthority('ADMIN_USER')">
              <a href="newShoe" class="btn btn-sm btn-neutral">New</a>
             </security:authorize>
            </div>
          </div>
        </div>
                 ...
                 <c:forEach var="shoe" items="${shoe}">
                  ...
                  <tr>
                     <th scope="row">
                      <div class="media align-items-center">
                        ...
                        <div class="media-body">
                          <span class="name mb-0 text-sm">${shoe.brand}</span>
                        </div>
                      </div>
                    </th>
                    ...
                    <td class="text-right">
								...
								<a class="btn btn-sm btn-primary" href="${buyLink}" onclick="if (!(confirm('Are you sure you want to Buy this shoe?'))) return false">Buy</a>
								 <security:authorize access="hasAnyAuthority('ADMIN_USER')">
