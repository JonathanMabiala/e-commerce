      ...
      <div class="row">
        <div class="col-xl-8 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form:form action ="save_customer" modelAttribute="user" method="POST">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <form:input path="password" type="password" id="input-description" class="form-control" placeholder="password" />
                      </div>
                    </div>
                     <div class="col-lg-6">
                      <div class="form-group">
